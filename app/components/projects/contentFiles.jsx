...
const project1Content = {
    ...
    githubUrl:"https://github.com/aaaarvieeee/Plane-Text",
...
const project2Content = {
    ...
    githubUrl:"https://github.com/Jhio0/CarbonFootPrint_Capstone",
    slides: [
      {
        src: require("../../../public/assets/projects/project2Carbon/img1.png"),
        alt: "Image 1 for carousel"
...
const project3Content = {
    ...
    deployment: "https://styles-boutique.vercel.app/",
    githubUrl:"https://github.com/Jhio0/Styles-Boutique",
    slides: [
      {
        src: require("../../../public/assets/projects/project3Style/img1.png"),
        alt: "Image 1 for carousel"
      },
      {
        src: require("../../../public/assets/projects/project3Style/img2.png"),
        alt: "Image 2 for carousel"
      },
      {
        src: require("../../../public/assets/projects/project3Style/img3.png"),
        alt: "Image 3 for carousel"
      },
      {
        src: require("../../../public/assets/projects/project3Style/img4.png"),
        alt: "Image 4 for carousel"
      },
      {
        src: require("../../../public/assets/projects/project3Style/img5.png"),
        alt: "Image 4 for carousel"
      }
    ]
  };
...
const project4Content = {
    ...
    deployment: "https://carbon-foot-print-capstone.vercel.app/",
    githubUrl:"https://github.com/Jhio0/weather-app",
    slides: [
      {
        src: require("../../../public/assets/projects/project2Carbon/img1.png"),
        alt: "Image 1 for carousel"
